...
class RewardWrapper(gym.Wrapper):
    ...
    '''
    def __init__(self, env, include_fuel=False, only_fuel=False, amplified_fuel=False):
        super().__init__(env)
        self.include_fuel = include_fuel
        self.only_fuel = only_fuel
        self.amplified_fuel = amplified_fuel
    ...
    def step(self, action):
        ...
        if (self.continuous and np.abs(action[1]) > 0.5) or (
            ...
            p = self.create_particle(0.7, impulse_pos[0], impulse_pos[1], s_power)
            p.ApplyLinearImpulse(
        ...
        return np.array(state, dtype=np.float32), reward, terminated, False, {'fuel_reward': fuel_reward}